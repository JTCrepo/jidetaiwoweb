...
'         <div class="topbar_login"><a href="https://jidetaiwoandco.com/crmportal/Clients/login"> My Account</a></div>'.
'       </div>'.
'     </div>'.
'   </div>'.
' </div>'.
...
'             <li class="nav-item active"><a class="nav-link" href="index_video.html"> Find a property <span class="caret"></span></a> <i class="fas fa-caret-down"></i>'.
'              </li>'.
'             <li class="nav-item"><a class="nav-link" href="about.html"> Market your property <span class="caret"></span></a> <i class="fas fa-caret-down"></i>'.
'              </li>'.
'             <li class="nav-item"><a class="nav-link" href="services.html"> Find a service <span class="caret"></span></a> <i class="fas fa-caret-down"></i>'.
'              </li>'.
'              <li class="nav-item"><a class="nav-link" href="career.html"> Our Team <span class="caret"></span></a> <i class="fas fa-caret-down"></i>'.
'              </li>'.
'              <li class="nav-item"><a class="nav-link" href="publications.html"> Why Us  <span class="caret"></span></a> <i class="fas fa-caret-down"></i>'.
'              </li>'.
...
'             <li><a href="#3a" data-toggle="tab">Property Valuation Request and Authentication</a> </li>'.
'           </ul>'.
...
'                         <input type="text" name=" Destination" placeholder="City" class="form-control">'.
'                       </div>'.
'                     </div>'.
'                     <div class="col-lg-3">'.
